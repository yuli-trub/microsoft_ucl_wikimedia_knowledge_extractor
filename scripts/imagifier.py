...
def convert_images_to_png(page_title, url=None, min_size=(50, 50)):
    """
    ...
    for image_url in images:
        ...
        try:
            ...
            os.makedirs("../data/images/svg", exist_ok=True)
            os.makedirs("../data/images/png", exist_ok=True)
            ...
            if image_url.endswith(".svg"):
                svg_path = f"../data/images/svg/{image_name_without_ext}.svg"
                ...
                try:
                    cairosvg.svg2png(
                        ...
                        write_to=f"../data/images/png/{image_name_without_ext}.png",
                    )
                ...
                try:
                    ...
                    if image.format != "PNG":
                        image.save(
                            f"../data/images/png/{image_name_without_ext}.png", "PNG"
                        )
                        print(f"Converted image to PNG: {image_name_without_ext}.png")
                    else:
                        save_image(
                            image_data,
                            f"../data/images/png/{image_name_without_ext}.png",
                        )
                    ...
                    save_image(
                        image_data,
                        f"../data/images/png/{image_name_without_ext}_error.png",
                    )
                    print(
                        f"Saved the problematic image for inspection: {image_name_without_ext}_error.png"
                    )
...
convert_images_to_png("Python (programming language)")
